...
class UploaderListAdapter(private val context: Context):
    RecyclerView.Adapter<UploaderListAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): UploaderListAdapter.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.fragment_request,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: UploaderListAdapter.ViewHolder, position: Int) {
